                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">结算费率低至2%，每日满10000元自动结算，上不封顶，提现手续费最低0.1元，最高20000元。</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-3 -->
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service">
                            ...
                            <div class="info">
                                ...
                                <p class="desc">采取T+1结算方式，交易金额满10000元，系统会于次日零点开始自动结算，不满10元亦可申请手动结算。</p>
                            </div>
                        </div>
                    </div>
                    <!-- end col-3 -->

...
<div id="pay0" class="api_block">
  ...
  <p>URL地址：<font color="#29389f"><?php echo $siteurl ?>submit.php</font>
  </p>
  <p>POST数据：<font color="#29389f">pid={商户ID}&amp;type={支付方式}&amp;out_trade_no={商户订单号}&amp;notify_url={服务器异步通知地址}&amp;return_url={页面跳转通知地址}&amp;name={商品名称}&amp;money={金额}&amp;sign={签名字符串}&amp;sign_type=MD5</font>
  </p>
  <p>请求参数说明：</p>
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>是</td>
        <td>String</td>
        <td>http://www.pay.com/return_url.php</td>
        <td>页面跳转通知地址</td>
      </tr>
      <tr>
        <td>商品名称</td>
      ...
      <tr>
        ...
        <td>签名算法<a href="https://opendocs.alipay.com/open/common/104741" target="_blank" style="color:#4585d2">点此查看</a></td>
      </tr>
      <tr>
        <td>签名类型</td>
        <td>sign_type</td>
...
<div id="pay1" class="api_block">
  ...
  <p>
    <font color="#777">此接口可用于服务器后端发起支付请求，会返回支付二维码链接或支付跳转url。</font>
  </p>
  <p>URL地址：<font color="#29389f"><?php echo $siteurl ?>mapi.php</font>
  </p>
  <p>POST数据：<font color="#29389f">pid={商户ID}&amp;type={支付方式}&amp;out_trade_no={商户订单号}&amp;notify_url={服务器异步通知地址}&amp;return_url={页面跳转通知地址}&amp;name={商品名称}&amp;money={金额}&amp;clientip={用户IP地址}&amp;device={设备类型}&amp;sign={签名字符串}&amp;sign_type=MD5</font>
  </p>
  <p>请求参数说明：</p>
  <table class="table table-bordered table-hover">
    <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>String</td>
        <td>pc</td>
        <td>根据当前用户浏览器的UA判断，<br />传入用户所使用的浏览器<br />或设备类型，默认为pc<br /><a href="#pay5" style="color:#4585d2">设备类型列表</a></td>
      </tr>
      <tr>
        <td>业务扩展参数</td>
        <td>param</td>
  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>payurl</td>
        <td>String</td>
        <td><?php echo $siteurl ?>pay/wxpay/202010903/</td>
  ...
  <p>
    <font color="#993939">注：payurl、qrcode、urlscheme 三个参数只会返回其中一个</font>
  </p>
</div>
<div id="pay2" class="api_block">
  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>String</td>
        <td>202cb962ac59075b964b07152d234b70</td>
        <td>签名算法与<a href="https://doc.open.alipay.com/docs/doc.htm?treeId=62&articleId=104741&docType=1" target="_blank">支付宝签名算法</a>相同</td>
      </tr>
      <tr>
        <td>签名类型</td>
        <td>sign_type</td>
  ...
  <p>
    <font color="#993939">收到异步通知后，需返回success以表示服务器接收到了订单通知</font>
  </p>
</div>
...
<div id="api1" class="api_block">
  ...
  <p>URL地址：<font color="#29389f"><?php echo $siteurl ?>api.php?act=query&amp;pid={商户ID}&amp;key={商户密钥}</font>
  </p>
  <p>请求参数说明：</p>
  <table class="table table-bordered table-hover">
    <thead>
...
<div id="api3" class="api_block">
  ...
  <p>URL地址：<font color="#29389f"><?php echo $siteurl ?>api.php?act=settle&amp;pid={商户ID}&amp;key={商户密钥}</font>
  </p>
  <p>请求参数说明：</p>
  <table class="table table-bordered table-hover">
    <thead>
...
<div id="api4" class="api_block">
  ...
  <p>URL地址：<font color="#29389f"><?php echo $siteurl ?>api.php?act=order&amp;pid={商户ID}&amp;key={商户密钥}&amp;out_trade_no={商户订单号}</font>
  </p>
  <p>请求参数说明：</p>
  <table class="table table-bordered table-hover">
    <thead>
...
<div id="api5" class="api_block">
  ...
  <p>URL地址：<font color="#29389f"><?php echo $siteurl ?>api.php?act=orders&amp;pid={商户ID}&amp;key={商户密钥}</font>
  </p>
  <p>请求参数说明：</p>
  <table class="table table-bordered table-hover">
    <thead>

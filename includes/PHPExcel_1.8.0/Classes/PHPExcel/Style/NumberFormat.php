...
class PHPExcel_Style_NumberFormat extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
	...
	private static function fillBuiltInFormatCodes()
	{
		...
		if (is_null(self::$_builtInFormats)) {
			...
			self::$_builtInFormats[14] = 'yyyy/m/d';
            ...
            self::$_builtInFormats[31] = 'yyyy年m月d日';
            self::$_builtInFormats[32] = 'h时mm分';
            self::$_builtInFormats[33] = 'h时mm分ss秒';
            self::$_builtInFormats[57] = 'yyyy年m月';
            self::$_builtInFormats[58] = 'm月d日';

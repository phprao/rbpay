...
} elseif (isset($islogin2) && $islogin2 == 1) {
			...
			<div class="m-b-lg">
				...
				<form name="form" class="form-validation" method="post" action="login.php">
					...
					<ul class="nav nav-tabs">
						<li style="width: 50%;" align="center" class="<?php echo (!isset($_GET['m']) || $_GET['m'] != 'key') ? 'active' : null; ?>">
					...
					<div class="tab-content">
						<div class="tab-pane active">
							<div class="list-group list-group-sm swaplogin">
								<?php if (isset($_GET['m']) && $_GET['m'] == 'key') { ?>
								...
								<?php } else { ?>
									...
									<div class="list-group-item">
										<input type="text" name="user" placeholder="手机号" value="" class="form-control no-border" onkeydown="if(event.keyCode==13){$('#submit').click()}">
									</div>
									<div class="list-group-item">

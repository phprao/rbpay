...
<div id="content" class="app-content" role="main">
	<div class="app-content-body ">
		...
		<div class="bg-light lter b-b wrapper-md hidden-print">
			<h1 class="m-n font-thin h3">提现记录</h1>
		</div>
		<div class="wrapper-md control">
			...
			<div class="panel panel-default">
				<div class="panel-heading font-bold">
					<h3 class="panel-title">提现记录<a href="javascript:searchClear()" class="btn btn-default btn-xs pull-right" title="刷新订单列表"><i class="fa fa-refresh"></i></a></h3>
				</div>
...
<script>
	...
	function searchExport() {
		...
		window.open('withdraw-table.php?dstatus=' + dstatus + '&action=export&' + query);
	}
</script>